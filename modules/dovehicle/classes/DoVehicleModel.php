...
/**
 * DoVehicleModel ObjectModel
 * Classe ObjectModel pour les modèles de véhicule
 */


class DoVehicleModel extends ObjectModel
{
    /**
     * @var int
     */
    ...
    public static $definition = [
        'table'   => 'do_vehicle_model',
        'primary' => 'id_do_vehicle_model',
        'fields'  => [
