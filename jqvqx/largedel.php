...
$sql = 'SELECT id_image FROM `ps_image` WHERE webp=1 and deleted=0  order by id_image';
//echo $sql;
$idCategories=array();
...
{  // printf("Select a retourné %d lignes.\n", $result->num_rows);
    foreach ($results as $row)
	{
        ...
        echo "rm -rf /var/www/vhosts/driveonly.fr/httpdocs/$path".$row['id_image'].".webp";
       // echo "rm -rf /var/www/vhosts/driveonly.fr/httpdocs/$path*.webp";
        shell_exec("rm -rf /var/www/vhosts/driveonly.fr/httpdocs/$path".$row['id_image'].".webp");
