...
jQuery(document).ready(function() {
    ...
    if (page_name == 'module-xipblog-single' && commentForm.length != 0) {
        var successMessage = commentForm.data('success-text');
        var errorMessage = commentForm.data('error-text');
        var waitText = commentForm.data('wait-text');
        var submitButton = commentForm.data('submit-text');
        $('.xipblog_submit_btn').on("click",function(e) {
            ...
            if(!$(this).hasClass("disabled")){
                ...
                function logErrprMessage(element, index, array) {
                  $('.xipblogs_message').append('<div class="xipblogs_error alert alert-danger">'+errorMessage+'</div');
                }
                function xipremove() {
                ...
                function logSuccessMessage(element, index, array) {
                  $('.xipblogs_message').append('<div class="xipblogs_success alert alert-success">'+successMessage+'</div>');
                }
                $.ajax({
                    url: xprt_base_dir + 'module/xipblog/ajax',
                    data: data,
                    type:'post',
                    dataType: 'json',
                    beforeSend: function(){
