...
<div class="wishlist product-item-wishlist">
	<a class="addToWishlist wishlistProd_{$product.id_product|intval}" href="#" title="{l s='Add to wishlist' d='Shop.Theme.Actions'}" rel="{$product.id_product|intval}" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', false, 1); return false;" title="{l s='Add to wishlist' d='Shop.Theme.Actions'}">
        <i class="font-heart"></i>
        <span>{l s='Add to wishlist' d='Shop.Theme.Actions'}</span>
	</a>
</div>
