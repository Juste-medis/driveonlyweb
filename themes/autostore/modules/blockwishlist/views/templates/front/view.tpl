...
<div id="view_wishlist">
    <h1 class="page-heading bottom-indent">
        {l s='Wishlist' d='Modules.Blockwishlist.Shop'}
    </h1>
    {if $wishlists}
        <p>
            <strong class="dark">
                {l s='Other wishlists of %1s %2s:' sprintf=[$current_wishlist.firstname, $current_wishlist.lastname] d='Modules.Blockwishlist.Shop'}
            </strong>
                        ...
                        <div class="col-xs-6 col-sm-12">
                            <div class="product_image">
                                <a
                                        ...
                                        title="{l s='Product detail' d='Modules.Blockwishlist.Shop'}">
                                    <img
                            ...
                            <div class="product_infos">
                                ...
                                <div class="wishlist_product_detail">
                                    ...
                                    <p class="form-group selector1">
                                        <span><strong>{l s='Priority' d='Modules.Blockwishlist.Shop'}:</strong> {$product.priority_name}</span>
                                    </p>
                                    <div class="btn_action">
                                        ...
                                        {else}
                                            <span class="button ajax_add_to_cart_button btn btn-default disabled">
												<span>{l s='Add to cart' d='Modules.Blockwishlist.Shop'}</span>
											</span>
                                        {/if}
                                        <a
                                                class="button lnk_view btn btn-default"
                                                href="{$link->getProductLink($product.id_product,  $product.link_rewrite, $product.category_rewrite)|escape:'html':'UTF-8'}"
                                                title="{l s='View' d='Modules.Blockwishlist.Shop'}"
                                                rel="nofollow">
                                            <span>{l s='View' d='Modules.Blockwishlist.Shop'}</span>
                                        </a>
                                    </div>
                                    <!-- .btn_action -->
                                </div>
