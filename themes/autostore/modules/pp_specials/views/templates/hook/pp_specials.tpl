        ...
        {else}
             <div class="col-md-12">
                 <div class="alert alert-warning">
                     {l s='No products with dropped prices' d='Modules.Homeonsaletab.Shop'}
                 </div>
             </div>
        {/if}
        <div class="text-center">
            <a class="more-btn btn big" href="{$allonsaleProductsLink}">{l s='All promotions' d='Modules.Homeonsaletab.Shop'}</a>
        </div>
    </div>
</div>
