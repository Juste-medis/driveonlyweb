...
<div class="{if $carousel_tabs == 'true'}in-tabs tab-pane fade{else}none-in-tabs{/if}{if $carousel_active  == 'true' && $carousel_arrows == 'true'} nav-active{/if}"{if $carousel_tabs == 'true'} id="ppnew"{/if}>
    <div class="container">
        ...
        <div class="text-center">
            <a class="more-btn btn big" href="{$allnewProductsLink}">{l s='All new products' d='Modules.Homenewtab.Shop'}</a>
        </div>
    </div>
</div>
