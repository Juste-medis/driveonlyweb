    ...
    <div class="block-promo">
      <div class="cart-voucher js-cart-voucher">
        ...
        <p class="promo-code-button display-promo{if $cart.discounts|count > 0} with-discounts{/if}">
          <span class="collapse-button" data-target="#promo-code" role="button" data-toggle="collapse" aria-expanded="{if $cart.discounts|count > 0}true{else}false{/if}" aria-controls="promo-code">
          ...
          <div class="promo-code">
            {block name='cart_voucher_form'}
              <form action="{$urls.pages.cart}" data-link-action="add-voucher" method="post">
                ...
                <button type="submit" class="btn fill"><span>{l s='Add' d='Shop.Theme.Actions'}</span></button>
              </form>
            {/block}
