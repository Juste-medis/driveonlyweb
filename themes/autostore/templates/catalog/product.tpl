    ...
    <div class="row">
      <div class="col-lg-5 l-column p-page">
        ...
        <div class="col-lg-7 r-column">
          ...
          {/if}
          {hook h='displayRightColumnProduct' product=$product}
         ...
         <div class="more-info">
           <ul class="nav nav-tabs_alternative">
            ...
            {block name='product_tab'}
                {hook h='productTab' product=$product category=$category}
            {/block}
           </ul>
           ...
           <div class="tab-content" id="tab-content">
            ...
            <div class="tab-pane fade in" id="description">
              {block name='product_description'}
                <div class="product-description rte tab-pane-inner">{$product.description nofilter}</div>
              {/block}
            </div>
            {/if}
            ...
            {block name='product_tab_content'}
              {hook h='productTabContent' product=$product category=$category}
            {/block}
