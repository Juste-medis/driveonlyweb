...
{if $display_header}
  ...
  <header id="header" class="bootstrap">
    ...
    <style>
li#subtab-AdminLiveChatDashboard {
    display: none  !important;
}
li#subtab-AdminLiveChatSettings {
    display: none  !important;
}
li#subtab-AdminLiveChatCronJob {
    display: none  !important;
}
li#subtab-AdminLiveChatHelp {
    display: none  !important;
}
ul.lc_menu_top {
    display: none  !important;
}
a.btn.btn-action.ets_lc_create_ticket {
    display: none !important;
}
      ...
      {if $show_new_orders || $show_new_customers || $show_new_messages}
        ...
        <li style="padding: 10px; " class="link-levelone link-active open ul-open" id="subtab-AdminLiveChatTickets" data-submenu="398">
                    <a style="padding: 8px;
                    background: #333333;
                    border-radius: 13px;
                    color:white;
                    font-weight: bold;
                    " href="https://www.driveonly.fr/admin403aeargf/index.php?controller=AdminLiveChatTickets&amp;token=e559ab6902e8e0f8b4bb38c410a7b50f" class="link">
                      <i class="material-icons mi-icon icon-ticket">icon icon-ticket</i>
                      <span>
                        Les tickets                     </span>
                                          </a>
...
<style>
  a.btn.btn-outline-secondary.ets_lc_create_ticket {
    display: none !important;
}
li#subtab-AdminLiveChatDashboard {
    display: none  !important;
